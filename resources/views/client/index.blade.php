        ...
        <div id="sequence">
            ...
            <ul class="sequence-canvas">
                <li class="animate-in">
                    ...
                    <div class="flat-image formBottom delay200" data-duration="5" data-bottom="true"><img src="{{ asset('asset/client/images/slide-1.png') }}" alt=""></div>
                </li>
                <li>
                    <div class="flat-caption caption2 formLeft delay400 text-center">
                        <h1>YEEZUS</h1>
                    ...
                    <div class="flat-image formBottom delay200" data-bottom="true"><img src="{{ asset('asset/client/images/slide-2.png') }}" alt=""></div>
                </li>
            </ul>
        </div>
    </div>
...
<style>
    .container_fullwidth {
      background-color: #f9f4f4; /* Change to your desired color */
    }
</style>
